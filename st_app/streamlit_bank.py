    ...
    if st.checkbox("#Rééquilibrage des données"):
        st.markdown(r"""Pour équilibrer un dataset, nous utilisons deux approches complémentaires : le suréchantillonnage et le sous-échantillonnage.
            ...
            **ADASYN** (Adaptive Synthetic Sampling) : génère davantage d’exemples autour des cas mal classés.
            ...
            Sous-échantillonnage (**Undersampling**) Cette méthode réduit la taille des classes majoritaires. Par exemple, la technique Tomek Links identifie les échantillons majoritaires se trouvant
            à proximité immédiate des exemples minoritaires et les élimine, atténuant ainsi le déséquilibre.
